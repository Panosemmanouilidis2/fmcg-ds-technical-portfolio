...
Click any badge to open the notebook directly in Google Colab and run it in your browser.
...
> ⚠️ Notebook 03 requires a GCP account. Notebooks 01, 02 and 04 run entirely in Colab with no cloud setup.
...
- SHAP analysis: 70% of Western Europe sell-out variance driven by seasonality, not promotion mechanics
